...
{{ utils.table({
    'Added': [
        ...
        'Emote `LavaAddict` in tribute to RedDiamonREC. Depicts volcano exploding red diamonds.',
        'Wintergatan music added to safe playlist.'
    ],
    'Changed': [
        'Rebellion duration buffed to 40 sec/dollar',
        '[`!cancelbit`][cancelbit-command] command now works at any time, even while in a game tile.',
